                    ...
                    <div className="row">
                        <div className="page-breadcrumb col-md-12">
                            <ol className="breadcrumb">
                                ...
                                <li className="active">Sửa Cửa Cuốn Hồ Chí Minh</li>
                            </ol>
                        </div>
                                            ...
                                            <div className="carousel-inner" role="listbox">
                                                <div className="item active">
                                                    <img width="740" height="630"
                                                         src="https://cuacuonkimthanhphat.com/wp-content/uploads/2019/05/sửa-cửa-cuốn-2.jpg"
                                                         className="attachment-post-thumbnail size-post-thumbnail wp-post-image"
                                                         alt=""
                                                         srcSet="https://cuacuonkimthanhphat.com/wp-content/uploads/2019/05/sửa-cửa-cuốn-2.jpg 740w, https://cuacuonkimthanhphat.com/wp-content/uploads/2019/05/sửa-cửa-cuốn-2-300x255.jpg 300w"
                                ...
                                <div className="row">
                                    <div className="col-lg-7 col-md-6">
                                        <div className="entry-detail">
                                            <p className="title">Sửa Cửa Cuốn Hồ Chí Minh</p>
                                            <p></p>
                                            <p><b>Mã sản phẩm:</b></p>
                                            <p><b>Trạng thái:</b>
                                            ...
                                            <p></p>
                                            <p className="price"><b>Giá bán:</b> 200,000 ₫</p>
                                            <p className="price-old"><b>Giá thị trường:</b> <span>300,000</span> ₫ </p>
                                            ...
                                            <div className="content-lien-he">
                                                <ul className="list-group">
                                                    <li className="list-group-item">
                                                        ...
                                                        <span className="lh-phone"><a
                                                            href="tel:0988318978">0988318978</a></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
